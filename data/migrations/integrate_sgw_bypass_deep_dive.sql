...
ALTER TABLE vehicles ADD COLUMN sgw_required INTEGER DEFAULT 0;
ALTER TABLE vehicles ADD COLUMN bypass_method TEXT;
ALTER TABLE vehicles ADD COLUMN vin_coded_key INTEGER DEFAULT 0;
...
WHERE make IN ('Jeep', 'Ram', 'RAM', 'Dodge', 'Chrysler')
    AND EXISTS (
        ...
        WHERE vv.vehicle_id = vehicles.id 
