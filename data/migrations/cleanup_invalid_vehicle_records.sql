...
-- Removes incorrectly imported key blank/remote entries from vehicles_master
...
-- SELECT COUNT(*) FROM vehicles_master WHERE model LIKE '%Transponder%' OR model LIKE '%Remote%' OR model LIKE '%Key Blank%';
-- Expected result: 0
