...
function renderFccTable() {
    ...
    tbody.innerHTML = pageData.map(r => {
        ...
        // Escape strings for safe insertion into HTML attribute
        const safeAmazonLink = (amazonLink || '').replace(/'/g, "\\'");
        const safeFccId = (fccId || '').replace(/'/g, "\\'");
        ...
        return `
                ...
                : '<span style="color: var(--text-muted);">-</span>'}
                    ...
                    <td><a href="${amazonLink}"
                        target="_blank"
                        onclick="logActivity('affiliate_click', { type: 'fcc_table', fcc_id: '${safeFccId}', asin: '${primaryAsin || ''}' })"
                        class="amazon-btn">🛒</a>
                    </td>
                                                                                </tr>
                    `;
                ...
                return `
                        ...
                        : ''}
                                                                                    ...
                                                                                    <div class="fcc-card-actions">
                                                                                        <a href="${amazonLink}"
                                                                                            target="_blank"
                                                                                            onclick="logActivity('affiliate_click', { type: 'fcc_card', fcc_id: '${(fccId || '').replace(/'/g, "\\'")}', asin: '${primaryAsin || ''}' })"
