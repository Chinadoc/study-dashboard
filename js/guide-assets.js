...
// Open an HTML guide in a modal iframe (mobile-responsive)
window.openHtmlGuide = function (htmlUrl, title) {
    ...
    // Mobile-responsive container with touch-friendly sizing
    modalBody.innerHTML = `
        <div style="position: relative; width: 100%; height: calc(100vh - 120px); max-height: 80vh; background: white; border-radius: 8px; overflow: hidden;">
            <iframe src="${htmlUrl}" 
